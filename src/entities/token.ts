...
export const WETH = {
  ...
  [ChainId.DOEGCHAIN_TESTNET]: new Token(
  ...
  [ChainId.MANTRA]: new Token(ChainId.MANTRA, '0xE3047710EF6cB36Bcf1E58145529778eA7Cb5598', 18, 'WMANTRA', 'Wrapped MANTRA')
}
